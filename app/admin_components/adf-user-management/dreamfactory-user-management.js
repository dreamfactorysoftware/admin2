            ...
            return {
                ...
                link: function (scope, elem, attrs) {
                    ...
                    scope._loginRequest = function (credsDataObj) {
                        ...
                        return $http.post(DSP_URL + '/api/v1/user/session', credsDataObj);
                    };
        ...
        return {
            ...
            link: function (scope, elem, attrs) {
                ...
                scope._resetPasswordRequest = function (requestDataObj) {
                    ...
                    return $http.post(DSP_URL + '/api/v1/user/password?reset=true', requestDataObj);
                };

                scope._resetPasswordSQ = function (requestDataObj) {

                    // Post request for password change and return promise
                    return $http.post(DSP_URL + '/api/v1/user/password?login=false', requestDataObj);
                };
            ...
            return {
                ...
                link: function (scope, elem, attrs) {
                    ...
                    scope._logoutRequest = function () {
                        ...
                        return $http.delete(DSP_URL + '/api/v1/user/session');
                    };
            ...
            return {
                ...
                link: function (scope, elem, attrs) {
                    ...
                    scope._registerRequest = function (registerDataObj) {
                        ...
                        return $http({
                            url: DSP_URL + '/api/v1/user/register',
                            method: 'POST',
                            params: {
                                login: scope.options.login
                            },
                    ...
                    scope._getSystemConfig = function () {
                        ...
                        return $http.get(DSP_URL + '/api/v1/system/config');
                    };
...
//                                    }
    ...
    .service('UserDataService', ['$http', 'DSP_URL', 'XHRHelper', function ($http, DSP_URL, XHRHelper) {
        ...
        function _saveUserSetting(userSettings) {
            ...
            return $http({
                url: DSP_URL + '/api/v1/user/custom',
                method: 'POST',
                data: userSettings
            })
        }
        ...
        function _getUserSetting(setting, sync) {
            ...
            return $http({
                url: DSP_URL + '/api/v1/user/custom/' + setting,
                method: 'GET'
            })
        }
    ...
    .service('dfXHRHelper', ['DSP_URL', 'DSP_API_KEY', '$cookies', function (DSP_URL, DSP_API_KEY, $cookies) {
        ...
        function _makeRequest(_method, _url, _async, _params, _headers, _mimeType) {
            ...
            // Do XHR
            xhr.open(_method, DSP_URL + '/api/v1/' + _url + params, _async);
